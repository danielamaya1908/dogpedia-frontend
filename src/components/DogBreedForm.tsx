...
import { createDogBreed, updateDogBreed, getDogBreedById } from '../api/dogBreedApi';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (id) {
                ...
                await createDogBreed(dogBreed);
            }
            navigate('/');
        } catch (error) {
            console.error('Error submitting dog breed:', error);
            setError('Error al enviar los datos de la raza de perro.');
        }
    };
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative p-4 max-w-lg mx-auto bg-white bg-opacity-90 border border-gray-300 rounded-lg shadow-lg z-10 mt-12 lg:mt-24">
                ...
                >
                    {id ? 'Actualizar' : 'Agregar'} Raza de Perro
                </motion.h2>
